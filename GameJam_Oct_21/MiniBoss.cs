...
namespace GameJam_Oct_21
{
    class MiniBoss : Entity
    {
        ...
        public MiniBoss(string dialoag, int toalMinons,string name, float health, float defense,  Abilitie[] abilities):base(name, health, defense, abilities)
        {
            _totalMinons = toalMinons;
            _dialog = dialoag;

        }

        public Entity[] BossMinions(Abilitie[] abilities)
        {
